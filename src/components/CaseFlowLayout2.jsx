...
import useNonSpeech from "hooks/useCaseFlowForm";
	...
	const generateScore = async (content = "") => {
		try {
			...
			if (rubrics) {
				...
				finalScore = Number.isNaN(calculatedScore)
					? "0.00"
					...
					>
						<div className="col-12 px-1 py-2">
							<TopTimerComponents
								...
								isRecording={isRecording || isFormStarted}
								isPaused={isPaused || isFormPaused}
								check={check}
								loading={loading}
							/>
							<div
...
export default CaseFlowLayout2;
